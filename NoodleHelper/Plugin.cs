...
namespace NoodleHelper
{
    ...
    public class Plugin
    {
        ...
        // public const string HarmonyId = "com.github.YourGitHub.NoodleHelper";
        // internal static readonly HarmonyLib.Harmony harmony = new HarmonyLib.Harmony(HarmonyId);

        internal static Plugin Instance { get; private set; }
        internal static IPALogger Log { get; private set; }
        internal static NoodleHelperController PluginController { get { return NoodleHelperController.Instance; } }
        ...
        */
        ...
        {
            new GameObject("NoodleHelperController").AddComponent<NoodleHelperController>();
            BS_Utils.Utilities.BSEvents.gameSceneLoaded += OnSongLoad;
            //ApplyHarmonyPatches();
        }
        ...
        public void OnSongLoad()
        {
            try
            {
                var difficultyData = SongCore.Collections.RetrieveDifficultyData(BS_Utils.Plugin.LevelData.GameplayCoreSceneSetupData.difficultyBeatmap);
                if (difficultyData != null)
                {
                    Plugin.Log.Info(difficultyData.ToString());
                    Plugin.Log.Info(difficultyData.additionalDifficultyData._requirements.Contains("Noodle Extensions") ? "Has Noodle" : "No Noodle");
                }
            }
            catch (Exception e)
            {
